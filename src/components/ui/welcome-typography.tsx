...
import { CustomePersonalData, GitHubUser } from "@/types";

interface WelcomeTypographyProps {
 user: GitHubUser;
 data: CustomePersonalData;
}

const WelcomeTypography = ({ user, data }: WelcomeTypographyProps) => {
 return (
  <>
   ...
   <p className="text-md text-lg text-zinc-300 font-sans mt-2 cursor-default">
    {user?.bio}
   </p>
